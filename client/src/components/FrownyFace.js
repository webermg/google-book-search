...
export default function FrownyFace() {
  return (
    <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-emoji-frown" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
